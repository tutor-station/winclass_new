...
class AluminiController extends Controller
{
    ...
    public function front(){
        ...
        return view('quedecato.front.alumini',compact('alumini'));
    ...
    return view('quedecato.front.alumini.footer',compact('alumini'));
    ...
    public function footerupdate(Request $request,$id){
        ...
        return view('quedecato.front.alumini.view',compact('alumini'));
