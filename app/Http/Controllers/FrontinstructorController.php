...
class FrontinstructorController extends Controller
{
    public function index()
    {
        ...
        return view('quedecato.front.instructor.index',compact('instructors'));
    ...
    public function profile(Request $request, $id)
    {
        ...
        return view('quedecato.front.instructor.profile',compact('instructors','courses','user'));
    ...
    { 
        ...
        return view('quedecato.front.all.profile',compact('instructors','courses','user'));
    }
}
