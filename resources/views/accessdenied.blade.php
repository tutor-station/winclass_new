		...
		<hr>
			<form class="needs-validation" action="{{ url('/change-domain') }}" method="POST" novalidate>
				...
				<div class="form-group">
					...
					<br>
					<small class="text-muted">
						<i class="fa fa-question-circle"></i> {{ __('IF still facing the access denied error please contact')}} <a target="_blank" href="https://codecanyon.net/item/eclass-learning-management-system/25613271/support" title="{{ __('Support') }}">{{ __('Support') }}</a> {{ __('for update  domain.') }}.
					</small>
				</div>	
				<div class="form-group">
