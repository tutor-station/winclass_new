      ...
      <div class="card m-b-30">
        ...
        <div class="card-body">
          ...
          <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
            ...
            <a class="nav-link mb-2" id="v-pills-subject-tab" data-toggle="pill" href="#v-pills-subject" role="tab" aria-controls="v-pills-subject" aria-selected="false"><i class="feather icon-book-open mr-2"></i>{{ __('CourseSubject') }}</a>
    ...
    <div class="col-lg-7 col-xl-9">
      <div class="tab-content" id="v-pills-tabContent">
        ...
        <div class="tab-pane fade" id="v-pills-subject" role="tabpanel" aria-labelledby="v-pills-subject-tab">
          @include('admin.course.coursesubject.index')
        </div>
