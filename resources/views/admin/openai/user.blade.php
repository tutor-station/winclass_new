        ...
        <div class="col-lg-12">
            <div class="card dashboard-card m-b-30">
                ...
                <div class="card-header">
                    ...
                    <div>
                        <div class="widgetbar">
                            <a href="{{url('openai/create')}}" class="btn btn-primary-rgba" title="{{ __('Add Service')}}"><i class="feather icon-plus mr-2"></i>{{ __("Create AI Content")}}</a>
                            &nbsp; &nbsp;
                            <button type="button" class="float-right btn btn-danger-rgba mr-2" data-toggle="modal" data-target="#bulk_delete" title="{{ __('Delete Selected') }}">
