                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div class="edit-user-img">
                                  <img src="{{ url('/images/services/'.$data->image) }}" alt="{{ __('Image')}}" class="img-responsive image_size">
                                </div>
                                @else
                                <div class="edit-user-img">
                                  <img src="{{ asset('images/services/'.$data->tittle)}}"  title="{{ __('Image')}}" class="img-responsive img-circle">
                                </div>
                                @endif
                            </div>
