          ...
          <div class="accordion" id="accordionExample" class="w-100 mt-2">
            ...
            @forelse($homeworks as $homework)
              ...
              <div id="headingOne{{ filter_var($homework->id) }}" class="mb-2">
                <button class="w-100 bg-white bg-scondary text-left border" type="button" data-toggle="collapse" data-target="#collapseOne_{{ filter_var($homework->id) }}" aria-expanded="true" aria-controls="collapseOne">
