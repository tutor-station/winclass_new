                        ...
                        <div class="col-lg-4 col-md-6 ">
                            <div class="courses-item mb-30 hover-zoomin">
                                ...
                                <div class="courses-content">        
                                    ...
                                    <h3><a class="truncate" href="{{route('user.course.show',['id' => $course->id, 'slug' => $course->slug ])}}"> {{$course->title}}</a></h3>
                                     <p>{{ str_limit(preg_replace("/\r\n|\r|\n/",'',strip_tags(html_entity_decode($course->detail))) , $limit = 200, $end = '...') }}</p>
                                    <a href="{{route('user.course.show',['id' => $course->id, 'slug' => $course->slug ])}}" class="readmore">{{__('Read More')}} <i class="fal fa-long-arrow-right"></i></a>
                                </div>
                                <div class="icon">
