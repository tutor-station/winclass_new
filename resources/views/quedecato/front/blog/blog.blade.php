                 ...
                 <div class="breadcrumb-wrap2">
                         ...
                         <nav aria-label="breadcrumb">
                             <ol class="breadcrumb">
                                 ...
                                 <li class="breadcrumb-item active" aria-current="page">{{__('Current Affairs')}}</li>
                             </ol>
                         </nav>
                     </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="bsingle__post mb-50">
                         ...
                         <div class="bsingle__content">
                             ...
                             <h2><a href="{{ route('blog.detail', ['id' => $blog->id, 'slug' => $blog->slug ]) }}">{{ str_limit(preg_replace("/\r\n|\r|\n/",'',strip_tags(html_entity_decode($blog->heading ))) , $limit = 16, $end = '...') }}</a></h2>
                            <p>{{ str_limit(preg_replace("/\r\n|\r|\n/",'',strip_tags(html_entity_decode($blog->detail))) , $limit = 110, $end = '...') }}</p>
                             <div class="blog__btn">
                                 <a href="{{ route('blog.detail', ['id' => $blog->id, 'slug' => $blog->slug ]) }}" class="btn">{{__('Read More')}} <i class="fal fa-long-arrow-right"></i></a>
                             </div>
                         </div>
                    </div>
