                                    ...
                                    <div id="accordion" class="second-accordion">
                                        ...
                                        <div class="card">
                                            <div class="card-header" id="headingTwo{{ $chapter->id }}">
                                                <div class="mb-0">
                                                    <button class="btn btn-link col-lg-12" data-toggle="collapse" data-target="#collapseTwo{{ $chapter->id }}" aria-expanded="{{ $key == 0 ? 'true' : 'false' }}" aria-controls="collapseTwo">
