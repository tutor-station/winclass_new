            ...
            <div class="col-lg-4 col-md-6 ">
                <div class="courses-item mb-30 hover-zoomin">
                    <div class="thumb fix">
                        ...
                        <a
                            href="{{ route('course.content',['id' => $enrol->courses->id, 'slug' => $enrol->courses->slug ]) }}"><img src="{{ asset('images/course/'.$enrol->courses->preview_image) }}" alt="contact-bg-an-01">
                        </a>
                        @else
                        <a
                            href="{{ route('course.content',['id' => $enrol->courses->id, 'slug' => $enrol->courses->slug ]) }}"><img src="{{ asset('images/course/'.$enrol->courses->preview_image) }}" alt="contact-bg-an-01"></a>
                        @endif
                    </div>
                    <div class="courses-content">                                    
                        ...
                        <h3>
                            <a
                            href="{{ route('course.content',['id' => $enrol->courses->id, 'slug' => $enrol->courses->slug ]) }}"> {{ optional($enrol->courses->user)['fname'] }}</a>
                        </h3>
                            <p> {{ str_limit($enrol->courses->title, $limit = 100, $end = '...') }}</p>
                        <a
                            href="{{ route('course.content',['id' => $enrol->courses->id, 'slug' => $enrol->courses->slug ]) }}" class="readmore">Read More <i class="fal fa-long-arrow-right"></i></a>
                    </div>
                    <div class="icon">
                        @if($enrol->user['user_img'] !== NULL && $enrol->user['user_img'] !== '')
                        <a href="{{ route('all/profile',$enrol->user->id) }}" title=""><img src="{{ asset('images/user_img/'.$enrol->user['user_img']) }}" alt="img" height="height: 35px;"></a>
                        @else
                        <a href="{{ route('all/profile',$enrol->user->id) }}" title=""><img src="{{ url('frontcss/img/icon/cou-icon.png') }}" alt="img"></a>
                        @endif
                    </div>
                </div>
            </div>
