                    ...
                    <div class="two-column">
                        <div class="row">
                             <div class="image-column col-xl-6 col-lg-12 col-md-12">
                                <figure class="image"><img src="{{url('frontcss/img/gallery/protfolio-img04.png')}}" alt=""></figure>
                            </div>
                            <div class="text-column col-xl-6 col-lg-12 col-md-12">
                               <figure class="image"><img src="{{url('frontcss/img/gallery/protfolio-img06.png')}}" alt=""></figure>
                            </div>
                    ...
                    <div class="two-column">
                        <div class="row">
                             <div class="image-column col-xl-12 col-lg-12 col-md-12">
                                <figure class="image"><img src="{{url('frontcss/img/gallery/protfolio-img02.png')}}" alt=""></figure>
                            </div>
