                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12">
                                        <div class="courses-item mb-30 ms-0 me-0 hover-zoomin  protip">
                                            ...
                                            <div class="courses-content"> 
                                                <h3><a href="{{ route('course.content',['id' => $enrol->courses->id, 'slug' => $enrol->courses->slug ]) }}"> {{ $enrol->courses->title }}</a></h3>
                                    ...
                                    <div class="col-lg-6 col-md-12 col-12">
                                        <div class="courses-item mb-30 ms-0 me-0 hover-zoomin  protip">
                                            ...
                                            <div class="courses-content">
                                                <h3><a
                                                    href="{{ route('course.content',['id' => $coursess->id, 'slug' => $coursess->slug ]) }}">{{ str_limit($coursess->title, $limit = 35, $end = '...') }}</a></h3>
                                                <div class="mycourse-progress">
                                                    <?php
