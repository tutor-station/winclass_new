    ...
    <div class="col-lg-4">
        <div class="courses-item mb-30 hover-zoomin ms-0 me-0 protip">
            ...
            <div class="courses-content">    
                ...
                <h3><a href="{{ route('user.course.show',['id' => $c->id, 'slug' => $c->slug ]) }}" tabindex="0">{{ $c->title }}</a></h3>
                <p>{{ strip_tags(str_limit($c['short_detail'], $limit = 200, $end = '...')) }}</p>

                    <a href="{{ route('user.course.show',['id' => $c->id, 'slug' => $c->slug ]) }}" class="readmore" tabindex="0">{{ __('Read More') }} <i class="fal fa-long-arrow-right"></i></a>
                </p>
            </div>
            <div class="icon">
