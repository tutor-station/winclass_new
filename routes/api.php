...
Route::post('otp_verify', 'Api\Auth\RegisterController@otp_verify');



Route::post('forgotOtpSend', 'Api\Auth\LoginController@forgotSendOtp');
Route::post('forgotOtpVerify', 'Api\Auth\LoginController@forgotOtpVerify');
Route::post('resetPassword', 'Api\Auth\LoginController@resetPassword');
...
Route::get('getAllCurrentAffairs', 'Api\MainController@getAllCurrentAffairs');
Route::get('json', 'Api\MainController@test');

Route::get('curent-affairs', 'Api\MainController@getCurrentAffairs');

Route::get('coupon-by-course-id', 'Api\MainController@getCouponByCourseId');

Route::post('transfersData', 'Api\MainController@transfersData');
...
Route::get('course/detail', 'Api\MainController@detailpage');
...
Route::get('course/contentOLD/{id}', 'Api\MainController@coursecontentOLD');

Route::get('liveclasses', 'Api\MainController@liveClassesAll');
Route::get('liveclasses_tab', 'Api\MainController@todayLiveClasses');
...
Route::group(['middleware' => ['auth:api']], function (){
	...
	Route::post('orderSave', 'Api\PaymentController@orderSave');
    ...
    Route::post('student_result', 'Api\MainController@student_result');
...
Route::post('save-comment', 'Api\MainController@saveComment');
Route::get('get-all-comments', 'Api\MainController@getAllComments');

Route::get('quiz_report_by_topic_id', 'Api\MainController@getQuizReport');
Route::get('quiz_reattempt_list', 'Api\MainController@quiz_reattempt_list');
// Route::get('all_quiz_report_by_topic_id', 'Api\MainController@getAllQuiz');

Route::get('/payment/createTransferRazorPay', 'Api\PaymentController@createTransferRazorPay');
Route::get('/payment/checkRazorpayOrderStatus', 'Api\PaymentController@checkRazorpayOrderStatus');



Route::post('updateAppVersion', 'Api\MainController@updateAppVersion');
