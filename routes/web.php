...
Route::get('/userDetailAdd/{id}', [App\Http\Controllers\Auth\RegisterController::class, 'userDetailAdd']);
...
Route::get('/resetNewPassword/{id}', [App\Http\Controllers\Auth\ResetPasswordController::class, 'resetNewPassword']);
...
Route::get('trans',function(){
    ...
    Route::get('updateNewPassword','Auth\ResetPasswordController@updateNewPassword')->name('updateNewPassword');
    //Installer Routes
    ...
    Route::middleware(['is_active', 'auth', 'maintanance_mode'])->group(function () {
        ...
        Route::middleware(['admin_instructor','auth'])->group(function () {
            ...
            Route::resource('coursesubject','CourseSubjectController');
            Route::post('coursesubject','CourseSubjectController@store')->name('coursesubject.store');
            ...
            // liveclass route
            Route::get('liveclass', 'CourseclassController@getAllLiveClasses')->name('liveclass');
            Route::get('liveclass/create', 'CourseclassController@createLiveClass')->name('liveclass.show');
            Route::post('liveclass/create', 'CourseclassController@storeLiveClass')->name('liveclass.store');
            Route::get('liveclass/{id}/edit', 'CourseclassController@liveClassEdit')->name('liveclass.edit');
            Route::post('liveclass/update', 'CourseclassController@updateliveClass')->name('liveclass.update');
            Route::get("getChapterByCourseId","CourseclassController@getChapterByCourseId");
    ...
    Route::get('test-series','CourseController@testSeries')->name('test-series'); 
    ...
    Route::middleware(['is_verified', '2fa', 'maintanance_mode','switch_languages'])->group(function () {
        ...
        Route::get('get-all-comment/{id}', 'CourseclassController@getAllComments')->name('get-all-comment.show');
        Route::get('get-all-comment-return', 'CourseclassController@getAllCommentsReturn')->name('get-all-comment-return');
...
Route::get('testTopic','QuizTopicController@showTestTopic')->name('testTopic.show');
Route::get('addTestTopic','QuizTopicController@addTestTopic')->name('testTopic.create');
Route::get('EditTestTopic/{id}','QuizTopicController@EditTestTopic')->name('EditTestTopic');

Route::get('AllQuestions','QuizController@showAllQuestions')->name('AllQuestions.show');
Route::post('Newquestions', 'QuizController@questionStore')->name('Newquestions.store');
Route::get('questionEdit/{id}', 'QuizController@EditQuestion')->name('questionEdit');
Route::post('questionUpdate', 'QuizController@QuestionUpdate')->name('assignQuestions.update');

Route::get('assignQuestions/{id}','QuizController@assignQuestionShow')->name('assignQuestions.show');
Route::post('assignQuestionsSave', 'QuizController@assignQuestionsStore')->name('assignQuestions.store');

Route::get('viewAssignedQuestions/{id}','QuizController@viewAssignedQuestion')->name('viewAssignedQuestions.show');

Route::get("getTopicsByChapterId","CourseSubjectController@getTopicsByChapterId");
