            ...
            <tbody id="sortable">
              ...
              <tr class="sortable row1" data-id="<?php echo e($cat->id); ?>">
                ...
                <td>
                  ...
                  <?php endif; ?>
                   <a class="btn btn-warning btn-sm text-white p-1" href="<?php echo e(route('get-all-comment.show', $cat->id)); ?>" target="_blank">
                        <i class="feather icon-eye mr-1"></i><?php echo e(__("Comments")); ?></a>
                      </a>
                ...
                <form enctype="multipart/form-data" id="demo-form2" method="post"
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12" id="liveclassBox" style="display:none">
                      ...
                      <br>
                      <input type="datetime-local" id="date_time" name="date_time" placeholder="dd/mm/yyyy"
...
<?php $__env->stopSection(); ?><?php /**PATH /var/www/html/resources/views/admin/course/courseclass/index.blade.php ENDPATH**/ ?>