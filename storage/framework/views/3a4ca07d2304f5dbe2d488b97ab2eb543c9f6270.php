           ...
           <div class="row">
                <div class="col-md-6">
                  ...
                  <select name="course_id" id="course_id" class="form-control select2" disabled>
                      ...
                      <option value="<?php echo e($cor_val->id); ?>" <?= ($cor_val->id == $topic->course_id) ? "selected" : "" ?> ><?php echo e($cor_val->title); ?></option>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </select>
                </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/course/quiztopic/editTestTopic.blade.php ENDPATH**/ ?>