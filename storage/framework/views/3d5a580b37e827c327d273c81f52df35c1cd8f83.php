          ...
          <div class="modal-body">
            <form id="demo-form2" method="post" action="<?php echo e(route('coursechapter.store')); ?>" data-parsley-validate
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <label for="exampleInputDetails"><?php echo e(__('Is Topic Wise')); ?>:</label><br>
                  <label class="switch">
                      <input class="slider" type="checkbox" name="is_topic_wise" />
                      <span class="knob"></span>
                    </label>
                </div>
              </div>
...
<?php /**PATH /var/www/html/resources/views/admin/course/coursechapter/index.blade.php ENDPATH**/ ?>