                ...
                <div class="card-header">
                    ...
                    <div>
                      <div class="widgetbar">
                          ...
                          <a href="<?php echo e(url('facts/create')); ?>" class="btn btn-primary-rgba" title="<?php echo e(__('Add Slider Fact')); ?>"><i class="feather icon-plus mr-2"></i><?php echo e(__("Add Slider Fact")); ?></a>
                          <?php endif; ?>
                                ...
                                <td>
                                 <div class="dropdown">
                                     ...
                                     <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton3">
                                         ...
                                         <a class="dropdown-item" href="<?php echo e(route('facts.edit',$fact->id)); ?>" title="<?php echo e(__('Edit')); ?>"><i class="feather icon-edit mr-2"></i><?php echo e(__("Edit")); ?></a>
                                         <?php endif; ?>
                                         <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('front-settings.fact-slider.delete')): ?>
