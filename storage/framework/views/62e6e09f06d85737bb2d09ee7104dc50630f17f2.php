...
<link rel="shortcut icon" type="image/x-icon" href="<?php echo e(url('images/favicon/'.$gsetting->favicon)); ?>">
...
<?php echo $__env->yieldContent('custom-head'); ?><?php /**PATH /var/www/html/resources/views/theme2/head.blade.php ENDPATH**/ ?>