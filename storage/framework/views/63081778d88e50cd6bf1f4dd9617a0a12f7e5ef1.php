...
<?php $__env->startSection('title', 'Create Trusted Slider - Admin'); ?>
    ...
    <div class="col-lg-12">
      <div class="card dashboard-card m-b-30">
        <div class="card-header">
          <h5 class="card-title"><?php echo e(__('Add Trusted Slider')); ?></h5>
          <div>
            <div class="widgetbar">
            ...
            <div class="row">
              <div class="form-group col-md-4">
                <label for="exampleInputTit1e"><?php echo e(__('URL')); ?>:<sup class="redstar">*</sup></label>
                    <input class="form-control" required type="url" name="url" placeholder="<?php echo e(__('Please Enter Your Trusted URL')); ?>">
              </div>
              <div class="form-group col-md-4">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/trusted/insert.blade.php ENDPATH**/ ?>