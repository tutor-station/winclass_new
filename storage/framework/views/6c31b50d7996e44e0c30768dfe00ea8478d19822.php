...
<?php $__env->startSection('title', 'Breadcrumb - Setting'); ?>
        ...
        <div class="col-lg-12">
            <div class="card dashboard-card m-b-30">
                <div class="card-header">
                    <h5 class="card-title"><?php echo e(__('Breadcrumb')); ?></h5>
                </div>
                <div class="card-body">
                    <form class="form" action="<?php echo e(route('breadcum.update')); ?>" method="POST" novalidate
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                <label class="text-dark"><?php echo e(__('Breadcrumb Text')); ?>:</label>
                                <input name="text" value="<?php echo e($setting->text); ?>" autofocus="" type="text"
                                    ...
                                    placeholder="<?php echo e(__('Enter Breadcrumb Text')); ?>" required="">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/breadcum/setting.blade.php ENDPATH**/ ?>