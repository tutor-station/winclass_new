...
<?php $__env->startSection('title', 'Feature Settings - Admin'); ?>
    ...
    <div class="col-lg-12">
        <div class="card dashboard-card m-b-30">
            <div class="card-header">
                <h5 class="card-title"><?php echo e(__('Feature Settings')); ?></h5>
            </div>
            <div class="card-body">
                <form class="form" action="<?php echo e(route('featuresetting.update')); ?>" method="POST" novalidate
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <?php else: ?>
                            <img src="<?php echo e(Avatar::create($feasetting->tittle)->toBase64()); ?>" alt="<?php echo e(__('Image')); ?>"
                                class="img-fluid">
                            <?php endif; ?>
                        </div>
                    </div>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/feature/setting.blade.php ENDPATH**/ ?>