...
<div class="contentbar bardashboard-card">
        ...
        <div class="col-lg-12">
            <div class="alert alert-success alert-dismissible fade show"> 
                ...
                <form action="<?php echo e(url("/merge-quick-update")); ?>" method="POST" class="float-right d-none updaterform">
                    ...
                    <button class="btn btn-sm btn-primary-rgba" title="<?php echo e(__('Update Now')); ?>">
                        <i class="feather icon-check-circle"></i> <?php echo e(__("Update Now")); ?>

                    </button>
                </form>        
                <button type="button" class="close" data-dismiss="alert" aria-label="Close" title="<?php echo e(__('Close')); ?>">
    ...
    <div class="card m-b-30">
        ...
        <!-- ===================== -->
            <small class="text-warning process-fonts"><i class="fa fa-info-circle"></i> <?php echo e(__('Important Note:')); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/ota/process.blade.php ENDPATH**/ ?>