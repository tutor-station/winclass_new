...
<?php $__env->startSection('title', 'FAQs Students'); ?>
    ...
    <div class="col-lg-12">
        <div class="card dashboard-card m-b-30">
                ...
                <div class="card-header">
                    <h5 class="card-box"><?php echo e(__('FAQs Students')); ?></h5>
                    <div>
                        <div class="widgetbar">
                        ...
                        <button type="button" class="float-right btn btn-danger-rgba mr-2" data-toggle="modal" data-target="#bulk_delete" title="<?php echo e(__('Delete Selected')); ?>"><i
                          ...
                          <a href="<?php echo e(url('faq/create')); ?>" class="float-right btn btn-primary-rgba mr-2" title="<?php echo e(__('Add Faq')); ?>"><i class="feather icon-plus mr-2"></i><?php echo e(__('Add FAQ')); ?></a>
                        <?php endif; ?>
                        </div>
                      </div>
                </div> 
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
                                            ...
                                            <a class="dropdown-item" href="<?php echo e(url('faq/'.$p->id.'/edit')); ?>" title="<?php echo e(__('Edit')); ?>"><i class="feather icon-edit mr-2"></i><?php echo e(__('Edit')); ?></a>
                                            <?php endif; ?>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('faq.faq-student.delete')): ?>
