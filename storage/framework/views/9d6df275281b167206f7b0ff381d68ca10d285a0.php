        ...
        <div class="col-md-12">
            <div class="card dashboard-card m-b-30">
                <div class="card-header">
                    <form action="<?php echo e(route('admin.push.notif')); ?>" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <?php echo csrf_field(); ?>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for=""><?php echo e(__('Title')); ?>: <span
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for=""><?php echo e(__('Message')); ?> : <span
                                            class="text-danger">*</span> </label>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for=""><?php echo e(__('Description')); ?> : <span
                                            class="text-danger">*</span> </label>
                            ...
                            <!-- <div class="col-md-12">
                                <div class="form-group">
                                    <label for=""><?php echo e(__('Schedule Date Time')); ?> : <span
                                            class="text-danger">*</span> </label>
                            ...
                            <div class="col-md-12">
                              <label for="appt"><?php echo e(__('Schedule Date Time')); ?></label><br>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for=""><?php echo e(__('Image')); ?> : <span
                                            class="text-danger">*</span> </label>
...
<?php $__env->stopSection(); ?> -->
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/push_notification/index.blade.php ENDPATH**/ ?>