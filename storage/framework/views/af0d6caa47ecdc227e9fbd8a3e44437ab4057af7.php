    ...
    <div class="col-lg-12">
      <div class="card dashboard-card m-b-30">
        <div class="card-header">
          <h5 class="box-title"><?php echo e(__('Edit Admin')); ?></h5>
          <div class="widgetbar">
            <a href="<?php echo e(url('user')); ?>" class="btn btn-primary-rgba mr-2" title="<?php echo e(__('Back')); ?>"><i
              ...
              <div class="row">
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="<?php echo e(__('Please Enter City')); ?>" onchange="get_state_country(this.value)" value="<?php echo e($cities?$cities->name:''); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/alladmin/edit.blade.php ENDPATH**/ ?>