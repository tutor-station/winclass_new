          ...
          <div class="row">
            ...
            <div class="col-md-4">
              ...
              <select name="course_type" class="form-control js-example-basic-single col-md-7 col-xs-12">
                  ...
                  <option <?= ($cor->course_type == "video") ? "selected" : ""; ?> value="video">Video</option>
                  <option <?= ($cor->course_type == "test") ? "selected" : ""; ?> value="test">Test Series</option>
              </select>
            </div>
...
<?php $__env->stopSection(); ?><?php /**PATH /var/www/html/resources/views/admin/course/editcor.blade.php ENDPATH**/ ?>