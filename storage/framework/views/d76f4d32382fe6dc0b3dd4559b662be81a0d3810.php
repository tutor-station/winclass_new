                ...
                <div class="col-lg-6 col-md-6">
                    <div class="infobar">
                        ...
                        <ul class="list-inline mb-0">
                            ...
                            <li class="mt-2 mr-2 list-inline-item">        
                                <a href="<?php echo e(url('openai/create')); ?>" class="menu-tigger infobar-icon" style="width: 100px;"><img src="https://eclass.mediacity.co.in/demo/public/admin_assets/assets/images/svg-icon/ai.svg" class="img-fluid" alt="Ai Tool" style="margin-right: 5px;"><span style="margin-top: -9px;font-size: 15px;">Ai Tool</span></a>
                            </li>

                            <!-- <li class="mt-2 mr-2 list-inline-item">        
                                <a href="<?php echo e(url('openai/create')); ?>" class="menu-tigger infobar-icon" style="width: 100px;"><img src="<?php echo e(url('admin_assets/assets/images/svg-icon/ai.svg')); ?>" class="img-fluid" style="margin-right: 5px;" alt="<?php echo e(__('Ai Tool')); ?>"><span style="margin-top: -9px;font-size: 15px;"><?php echo e(__('Ai Tool')); ?></span></a>
                            </li> -->
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="profilelink">
                                            <div class="dropdown-item">
                                                <div class="profilename">
                                                    <h5><?php echo e(Auth::user()->fname .' '. Auth::user()->lname); ?></h5>
                                                </div>
                                            </div>
                                            <div class="userbox">
...
<!-- End Breadcrumbbar --><?php /**PATH /var/www/html/resources/views/admin/layouts/topbar.blade.php ENDPATH**/ ?>