...
<?php $__env->startSection('title','Test Topic'); ?>
  ...
  <div class="col-lg-12">
    <div class="card m-b-30">
      <div class="card-header">
        ...
        <a href="<?php echo e(route('testTopic.create')); ?>" class="btn btn-primary-rgba"><i class="feather icon-plus "></i><?php echo e(__('Add Quiz')); ?> </a>
            <?php endif; ?>
      </div>
      <div class="card-body">
          ...
          <table id="" class="displaytable table table-striped table-bordered w-100">
            <thead>
              <tr>
                ...
                <th><?php echo e(__('Topic Name')); ?></th>
                ...
                <td>
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
                      ...
                      <a class="dropdown-item" href="<?php echo e(url('EditTestTopic/'.$topic->id)); ?>"><i
                          class="feather icon-edit mr-2"></i><?php echo e(__('Edit')); ?></a>
                      <?php endif; ?>

                      <a class="dropdown-item" href="<?php echo e(route('assignQuestions.show', $topic->id)); ?>"><i
                          class="feather icon-file-plus mr-2"></i><?php echo e(__('Assign Question')); ?></a>

                      <a class="dropdown-item" href="<?php echo e(route('viewAssignedQuestions.show', $topic->id)); ?>"><i
                          class="feather icon-file-plus mr-2"></i><?php echo e(__('View Assigned Question')); ?></a>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/course/quiztopic/testTopic.blade.php ENDPATH**/ ?>