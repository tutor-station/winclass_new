            ...
            <div class="col-xl-12 col-lg-12">
                <div class="breadcrumb-wrap text-left">
                    <div class="breadcrumb-title">
                        <h2><?php echo e(__('Affiliate Dashboard')); ?></h2>    
            ...
            <div class="breadcrumb-wrap2">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><?php echo e(__('Affiliate Dashboard')); ?></li>
                    </ol>
                </nav>
            </div>
        </div>
                    ...
                    <div class="row mt-4">
                        <div class="col-lg-4 col-3">  
                            <div class="affiliate-dashboard-wallet-img">
                                <img src="https://eclass.mediacity.co.in/demo/public/images/wallet.png" class="img-fluid" alt="">
                            </div>
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('theme2.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/quedecato/front/affiliate/dashboard.blade.php ENDPATH**/ ?>