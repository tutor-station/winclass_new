    ...
    <div class="col-lg-12">
      <div class="card dashboard-card m-b-30">
        <div class="card-header">
          <h5 class="card-title"><?php echo e(__('Edit Feature')); ?></h5>
          <div>
            <div class="widgetbar">
              <a href="<?php echo e(url('fact')); ?>" class="btn btn-primary-rgba" title="<?php echo e(__('Back')); ?>"><i class="feather icon-arrow-left mr-2"></i><?php echo e(__("Back")); ?></a>          
            </div>
          </div>
        </div>
        <div class="card-body">
            <form id="demo-form2" method="post" action="<?php echo e(route('feature.update',$data->id)); ?>" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div class="edit-user-img">
                                  <img src="<?php echo e(url('/images/feature/'.$data->image)); ?>" title="<?php echo e(__('Image')); ?>" class="img-responsive image_size">
                                </div>
                                <?php else: ?>
                                <div class="edit-user-img">
                                  <img src="<?php echo e(asset('images/feature/'.$data->tittle)); ?>" title="<?php echo e(__('Image')); ?>" class="img-responsive img-circle">
                                </div>
                                <?php endif; ?>
                            </div>
                            <div class="col-md-12">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/feature/edit.blade.php ENDPATH**/ ?>